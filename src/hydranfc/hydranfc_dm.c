...
#include "ff.h"
#include <stdio.h>
#include "hydranfc_dm.h"
#include "trf_pins.h"

extern volatile int irq; // in hydranfc.c
#define IRQ             irq
#define CLEAR_IRQ       {irq = 0;}
                    ...
                    void *pui16RxData, unsigned short *pui8RxLengthBytes, unsigned char *pui8RxLengthBits)
{
	...
	// Receiving with DM1
	Mifare_DM1_Enter();
	Mifare_DM1_Receive(pui16RxData, pui8RxLengthBytes, pui8RxLengthBits, (pui16ParityFlags & DM_RX_PARITY));
	Mifare_DM1_Exit();
}
...
//*****************************************************************************
//
//! Mifare_DM1_Receive - Builds rx packet as each bit is received
//!
...
//
//*****************************************************************************
void Mifare_DM1_Receive(unsigned int *pui16RxData, unsigned short *pui8ByteCount, unsigned char *pui8BitCount, unsigned char Parity_flag){  // polling method
